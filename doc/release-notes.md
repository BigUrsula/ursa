...
installer (on Windows) or just copy over /Applications/URSA-Qt (on Mac) or
...
first startup of Ursa Core will run a migration process which can take a few
