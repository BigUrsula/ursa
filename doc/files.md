...
* ursa.conf: contains configuration settings for ursad or ursa-qt
* ursad.pid: stores the process id of ursad while running
...
* debug.log: contains debug information and general logging generated by ursad or ursa-qt
