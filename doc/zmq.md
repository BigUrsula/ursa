...
The Ursa Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Ursa Core requires ZeroMQ API version 4.x or
...
From the perspective of ursad, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into ursad directly. Furthermore, no information is
...
using. URSAd appends an up-counting sequence number to each
