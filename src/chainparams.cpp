...
{
    const char* pszTimestamp = "Great things are built in Ursula is a beautiful virtual island complex uint256_base58";
    const CScript genesisOutputScript = CScript() << ParseHex("04e803757d261bd24fb9ebe0741d8cf55f17226fda171f912e3c250f550096c10e7921a9d568878a6d7b61dfdbed8539b4c6bf2ccd5546beab513ccad7ac4ff042") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreaseBlock = 2530333; // actual historical value
        consensus.nMasternodePaymentsIncreasePeriod = 576*30; // 17280 - actual historical value
        consensus.nInstantSendConfirmationsRequired = 6;
        consensus.nInstantSendKeepLock = 24;
        consensus.nBudgetPaymentsStartBlock = 2530333; // actual historical value
        consensus.nBudgetPaymentsCycleBlocks = 16616; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 2530333; //
	    ...
	    consensus.defaultAssumeValid = uint256S("0x00000d1564256befdf549ddf1c329c6d7a1da1890c56ddf7d508327d7c2cfb16"); 


        // Change mining algo
        nHHActivationTime=1709110800;                          
        ...
        genesis = CreateGenesisBlock(1707131965, 4506652, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000d1564256befdf549ddf1c329c6d7a1da1890c56ddf7d508327d7c2cfb16"));
        assert(genesis.hashMerkleRoot == uint256S("0xc714abff7f1552adb597e9e83a964530097d617cb296ff8b7af9c321aba9705c"));
        ...
        //vFixedSeeds.clear();
        vSeeds.emplace_back("seeds.bigursula.com");        
        //vSeeds.clear();
        

        // UrsulaCoin addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,68);
        // UrsulaCoin script addresses start with 'p'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,117);
        // UrsulaCoin private keys start with 'p' or 'e'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,253);
        // URSA BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // URSA BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // URSA BIP44 coin type is '522'
        nExtCoinType = 522;
        ...
        vSporkAddresses = {"Ua221zzFc2RwKFujDZAvvijjLyTeNgVS65"};
        nMinSporkKeys = 1;
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000d1564256befdf549ddf1c329c6d7a1da1890c56ddf7d508327d7c2cfb16")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0"); // 470000
        ...
        vSeeds.emplace_back("testnet-seed.bigursula.com"); // Just a static list of stable node(s), only supports x9
