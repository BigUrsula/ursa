...
const std::string strMessageMagic = "Ursula Signed Message:\n";
...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
    ...
    if (nPrevHeight == 0) { 
        nSubsidyBase = 9043530 ;
    } else if (nPrevHeight <= 480 ) { 
        nSubsidyBase = 170 ;
    } else if (nPrevHeight <= 10080 ) { 
        nSubsidyBase = 2500 ;
    } else if (nPrevHeight <= 20161 ) { 
        nSubsidyBase = 1281 ;
    } else if (nPrevHeight <= 30242 ) { 
        nSubsidyBase = 638 ;
    } else if (nPrevHeight <= 40323 ) { 
        nSubsidyBase = 424 ;
    } else if (nPrevHeight <= 50404 ) { 
        nSubsidyBase = 316 ;
    } else if (nPrevHeight <= 60485 ) { 
        nSubsidyBase = 252 ;
    } else if (nPrevHeight <= 70566 ) { 
        nSubsidyBase = 209 ;
    } else if (nPrevHeight <= 80647 ) { 
        nSubsidyBase = 179 ;
    } else if (nPrevHeight <= 90728 ) { 
        nSubsidyBase = 156 ;
    } else if (nPrevHeight <= 100809 ) { 
        nSubsidyBase = 138 ;
    } else if (nPrevHeight <= 110890 ) { 
        nSubsidyBase = 124 ;
    } else if (nPrevHeight <= 120971 ) { 
        nSubsidyBase = 112 ;
    } else if (nPrevHeight <= 131052 ) { 
        nSubsidyBase = 102 ;
    } else if (nPrevHeight <= 141133 ) { 
        nSubsidyBase = 94 ;
    } else if (nPrevHeight <= 151214 ) { 
        nSubsidyBase = 87 ;
    } else if (nPrevHeight <= 161295 ) { 
        nSubsidyBase = 81 ;
    } else if (nPrevHeight <= 171376 ) { 
        nSubsidyBase = 75 ;
    } else if (nPrevHeight <= 181457 ) { 
        nSubsidyBase = 71 ;
    } else if (nPrevHeight <= 191538 ) { 
        nSubsidyBase = 66 ;
    } else if (nPrevHeight <= 201619 ) { 
        nSubsidyBase = 63 ;
    } else if (nPrevHeight <= 211700 ) { 
        nSubsidyBase = 59 ;
    } else if (nPrevHeight <= 221781 ) { 
        nSubsidyBase = 56 ;
    } else if (nPrevHeight <= 231862 ) { 
        nSubsidyBase = 53 ;
    } else if (nPrevHeight <= 241943 ) { 
        nSubsidyBase = 51 ;
    } else if (nPrevHeight <= 252024 ) { 
        nSubsidyBase = 49 ;
    } else if (nPrevHeight <= 262105 ) { 
        nSubsidyBase = 46 ;
    } else if (nPrevHeight <= 272186 ) { 
        nSubsidyBase = 44 ;
    } else if (nPrevHeight <= 282267 ) { 
        nSubsidyBase = 43 ;
    } else if (nPrevHeight <= 292348 ) { 
        nSubsidyBase = 41 ;
    } else if (nPrevHeight <= 302429 ) { 
        nSubsidyBase = 39 ;
    } else if (nPrevHeight <= 312510 ) { 
        nSubsidyBase = 38 ;
    } else if (nPrevHeight <= 322591 ) { 
        nSubsidyBase = 36 ;
    } else if (nPrevHeight <= 332672 ) { 
        nSubsidyBase = 35 ;
    } else if (nPrevHeight <= 342753 ) { 
        nSubsidyBase = 34 ;
    } else if (nPrevHeight <= 352834 ) { 
        nSubsidyBase = 33 ;
    } else if (nPrevHeight <= 362915 ) { 
        nSubsidyBase = 32 ;
    } else if (nPrevHeight <= 372996 ) { 
        nSubsidyBase = 31 ;
    } else if (nPrevHeight <= 383077 ) { 
        nSubsidyBase = 30 ;
    } else if (nPrevHeight <= 393158 ) { 
        nSubsidyBase = 29 ;
    } else if (nPrevHeight <= 403239 ) { 
        nSubsidyBase = 28 ;
    } else if (nPrevHeight <= 413320 ) { 
        nSubsidyBase = 27 ;
    } else if (nPrevHeight <= 433482 ) { 
        nSubsidyBase = 26 ;
    } else if (nPrevHeight <= 443563 ) { 
        nSubsidyBase = 25 ;
    } else if (nPrevHeight <= 463725 ) { 
        nSubsidyBase = 24 ;
    } else if (nPrevHeight <= 473806 ) { 
        nSubsidyBase = 23 ;
    } else if (nPrevHeight <= 493968 ) { 
        nSubsidyBase = 22 ;
    } else if (nPrevHeight <= 514130 ) { 
        nSubsidyBase = 21 ;
    } else if (nPrevHeight <= 534292 ) { 
        nSubsidyBase = 20 ;
    } else if (nPrevHeight <= 554454 ) { 
        nSubsidyBase = 19 ;
    } else if (nPrevHeight <= 584697 ) { 
        nSubsidyBase = 18 ;
    } else if (nPrevHeight <= 604859 ) { 
        nSubsidyBase = 17 ;
    } else if (nPrevHeight <= 635102 ) { 
        nSubsidyBase = 16 ;
    } else if (nPrevHeight <= 665345 ) { 
        nSubsidyBase = 15 ;
    } else if (nPrevHeight <= 705669 ) { 
        nSubsidyBase = 14 ;
    } else if (nPrevHeight <= 745993 ) { 
        nSubsidyBase = 13 ;
    } else if (nPrevHeight <= 786317 ) { 
        nSubsidyBase = 12 ;
    } else if (nPrevHeight <= 836722 ) { 
        nSubsidyBase = 11 ;
    } else if (nPrevHeight <= 897208 ) { 
        nSubsidyBase = 10 ;
    } else if (nPrevHeight <= 967775 ) { 
        nSubsidyBase = 9 ;
    } else if (nPrevHeight <= 1038342 ) { 
        nSubsidyBase = 8 ;
    } else if (nPrevHeight <= 1048423 ) { 
        nSubsidyBase = 7 ;
    } else if (nPrevHeight <= 1239962 ) { 
        nSubsidyBase = 6 ;
    } else if (nPrevHeight <= 1371015 ) { 
        nSubsidyBase = 5 ;
    } else if (nPrevHeight <= 1532311 ) { 
        nSubsidyBase = 4 ;
    } else if (nPrevHeight <= 1733931 ) { 
        nSubsidyBase = 3 ;
    } else if (nPrevHeight <= 1996037 ) { 
        nSubsidyBase = 2 ;
    } else if (nPrevHeight <= 2187576 ) { 
        nSubsidyBase = 1 ;
    } else if (nPrevHeight <= 2217819 ) { 
        nSubsidyBase = 0.9 ;
    } else if (nPrevHeight <= 2258143 ) { 
        nSubsidyBase = 0.8 ;
    } else if (nPrevHeight <= 2298467 ) { 
        nSubsidyBase = 0.7 ;
    } else if (nPrevHeight <= 2338791 ) { 
        nSubsidyBase = 0.6 ;
    } else if (nPrevHeight <= 2379115 ) { 
        nSubsidyBase = 0.5 ;
    } else if (nPrevHeight <= 2429520 ) { 
        nSubsidyBase = 0.4 ;
    } else if (nPrevHeight <= 2469844 ) { 
        nSubsidyBase = 0.3 ;
    } else if (nPrevHeight <= 2520249 ) { 
        nSubsidyBase = 0.2 ;
    } else if (nPrevHeight <= 2530331 ) { 
        nSubsidyBase = 0.1 ;
    }  else {
        nSubsidyBase = 0;
    }	 
